...
import com.l.library.sysadmin.organization.dao.RoleMapper;
...
import com.l.library.sysadmin.organization.exception.RoleNotFoundException;
...
public class RoleService extends ServiceImpl<RoleMapper, Role> implements IRoleService {
    ...
    @Override
    @Cached(name = "role4user::", key="#userId")
