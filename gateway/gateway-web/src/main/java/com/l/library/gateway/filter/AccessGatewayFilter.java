package com.l.library.gateway.filter;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.l.library.auth.client.service.IAuthService;
import com.l.library.gateway.service.IPermissionService;
 ...
 */
@Configuration
@ComponentScan(basePackages = "com.l.library.auth.client")
@Slf4j
public class AccessGatewayFilter implements GlobalFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (permissionService.permission(authentication, url, method)) {
            ...
            builder.header(X_CLIENT_TOKEN, "TODO admin添加服务间简单认证");
